...
///////////////////////////////////////////////////////////////////////////// 
    ...
    /**
     * Metodo que recebe recebe uma lista de inteiros por parametro e a 
     * reorganiza da seguinte maneira: numeros pares devem ser colocados  
     * nas posições iniciais e ordenados, numeros impares devem ficar 
     * depois de todos numeros pares. Nao podem ser usados os atributos  
     * da lista, isto e´, apenas os seus metodos podem ser chamados.  
     * Tambem nao podem ser usadas outras listas ou vetores na sua solucao  
     * alem da lista recebida por parametro. Exemplo: 
     *      l1 = {1,6,7,2,3,4,5} 
     *      organizaLista(lista1) -> l1 = {2,4,6,1,7,3,5}
     *      l2 = {2,4,6,8,3,5}
     *      organizaLista(l2) -> l2 = {2,4,6,8,3,5}
     *
     * @param DoubleLinkedListOfInteger lista que contem os elementos a 
     * serem organizados.
     */
    public static void organizaLista (DoubleLinkedListOfInteger lista) {
        // Node auxEven = null;
        int tam = lista.size() - 1;
        int aux, menor = 0, indMenor = 0;
        for (int i = 0; i < tam; i++) {
            aux = lista.get(i);
            if (aux % 2 != 0) {
                lista.remove(i);
     ...
     */
    public String nome1 = "Vinicius de Borba";
    public String nome2 = "Leonardo Trindade Rubert";


    /**
     * Atribua o A NOTACAO O PARA O ALGORITMOS DO METODO removeEvenNumbers no
     * atributo abaixo. Para classe de complexidade logaritmica
     ...
     */    
    public String complexidadeMetodoRemoveEvenNumbers  = "O(n)";
